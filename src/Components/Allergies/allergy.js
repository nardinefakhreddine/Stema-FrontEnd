...
const url = "http://localhost:8000/api/allergy/getAll";
...
function handlePageChange (pageNumber) {;
    ...
    axios.get('http://localhost:8000/api/allergy/getAll?page='+ pageNumber,{
        headers: {
            Accept: 'application/json',
            'Content-Type': 'application/json',
          // Authorization: 'Bearer ' + Token,
    ...
    function search() {
        ...
        axios.get("http://localhost:8000/api/allergy/searchByName/"+Sname,{
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
              // Authorization: 'Bearer ' + Token,
    ...
    function onDelete(ID) {
        ...
        axios.delete(`http://localhost:8000/api/allergy/delete/` + ID, {
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
               //Authorization: 'Bearer ' + Token,
...
<div>
  ...
  <div style={{ width: '900px', display: 'inline-flex',justifyContent:'space-between' }}>
                ...
                <Link to="allergy/insert" style={{color:'green'
            }}><BiAddToQueue style={{ fontSize: '20px', fontWeight: 'bold' }}></BiAddToQueue>add new</Link>
                                           ...
                                           products !== null
                                                ? products.map(product => (
                                                    <tr key={product.id}>
                                                        ...
                                                        <td>
                                                            <Link to={`allergy/update/${product.id}`} className=" col-md-4 m-2 btn-sm mr-2"><AiIcons.AiFillEdit style={{color:'green'}}/></Link>
