...
const url = "http://localhost:8000/api/nutri/getAll";
...
function handlePageChange (pageNumber) {;
    ...
    axios.get('http://localhost:8000/api/nutri/getAll?page='+ pageNumber,{
        headers: {
            Accept: 'application/json',
            'Content-Type': 'application/json',
          // Authorization: 'Bearer ' + Token,
   ...
   function search() {
        ...
        axios.get("http://localhost:8000/api/nutri/searchByName/"+Sname,{
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
              // Authorization: 'Bearer ' + Token,
    ...
    function onDelete(ID) {
        ...
        axios.delete(`http://localhost:8000/api/nutri/delete/` + ID, {
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
               //Authorization: 'Bearer ' + Token,
                                           ...
                                           products !== null
                                                ? products.map(product => (
                                                    <tr key={product.id}>
                                                        ...
                                                        <td>
                                                            <Link to={`/nutri/update/${product.id}`} className=" col-md-4 m-2 btn-sm mr-2"><AiIcons.AiFillEdit style={{color:'green'}}/></Link>
